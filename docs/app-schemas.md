...
| `user_id` | `str` | `"default_user"` | Must match the `user_id` the run was originally started with — not currently validated server-side (see `issues-and-fixes.md`'s note on this). |
